error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/seat/SeatController.java:_empty_/HttpStatus#UNPROCESSABLE_ENTITY#
...
public class SeatController {
    ...
    public ResponseEntity<ResponseDto<SeatDTO>> cancel(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNPROCESSABLE@@_ENTITY)
