error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/lock/SeatLockController.java:org/springframework/web/bind/annotation/RequestBody#
...
empty definition using pc, found symbol in pc: org/springframework/web/bind/annotation/RequestBody#
...
public class SeatLockController {
    ...
    public ResponseEntity<ResponseDto<Void>> releaseLock(
        ...
        try {
            service.releaseLock(seatId, partnerId);
    ...
    public ResponseEntity<ResponseDto<SeatDTO>> bookSeat(
            ...
            @RequestParam Long partnerId) {
        try {
            return ResponseEntity.ok(ResponseDto.success(service.bookSeat(seatId, partnerId)));
        } catch (SeatNotFoundException | SeatLockNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ResponseDto.notFound(e.getMessage()));
        } catch (SeatNotAvailableException e) {
