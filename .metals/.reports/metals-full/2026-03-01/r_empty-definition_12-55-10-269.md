error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/lock/SeatLockController.java:_empty_/ResponseDto#
    ...
    public ResponseEntity<ResponseDto<SeatLockDTO>> getLock(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Response@@Dto.notFound(e.getMessage()));
        }
    }
