error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/scheduler/ScheduleController.java:_empty_/ScheduleOverlapException#
...
empty definition using pc, found symbol in pc: _empty_/ScheduleOverlapException#
...
public class ScheduleController {
    ...
    public ResponseEntity<ResponseDto<ScheduleDTO>> create(@RequestBody CreateScheduleRequest request) {
        ...
        } catch (ScheduleO@@verlapException e) {
