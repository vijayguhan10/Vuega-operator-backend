error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/config/DataInitializer.java:_empty_/Operator#builder#serviceEmail#accessToken#tokenExpiresAt#operatorName#organizationName#licenseStatus#accountStatus#busLimit#routeLimit#lastChecked#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/config/DataInitializer.java
empty definition using pc, found symbol in pc: _empty_/Operator#builder#serviceEmail#accessToken#tokenExpiresAt#operatorName#organizationName#licenseStatus#accountStatus#busLimit#routeLimit#lastChecked#
