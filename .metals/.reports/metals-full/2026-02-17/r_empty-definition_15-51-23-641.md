error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/scheduler/ScheduleService.java:_empty_/ScheduleRepository#existsOverlappingSchedule#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/scheduler/ScheduleService.java
empty definition using pc, found symbol in pc: _empty_/ScheduleRepository#existsOverlappingSchedule#
...
public class ScheduleService {
    ...
    public ScheduleDTO createSchedule(CreateScheduleRequest request) {
        ...
        if (repository.existsOverlappingS@@chedule(
                request.getBusId(),
