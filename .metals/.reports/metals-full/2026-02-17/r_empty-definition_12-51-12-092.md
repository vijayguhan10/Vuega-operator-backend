error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/operator_config/OperatorController.java:_empty_/ResponseDto#success#
...
public class OperatorController {
    ...
    public ResponseEntity<ResponseDto<OperatorDTO>> login(@RequestBody LoginRequest request) {
        ...
        if (result != null) {
            return ResponseEntity.ok(ResponseDto.succes@@s(result));
        }
