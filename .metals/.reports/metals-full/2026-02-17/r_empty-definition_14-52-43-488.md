error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/scheduler/ScheduleController.java:_empty_/ScheduleService#createSchedule#
...
empty definition using pc, found symbol in pc: _empty_/ScheduleService#createSchedule#
...
public class ScheduleController {
    ...
    public ResponseEntity<ResponseDto<ScheduleDTO>> create(@RequestBody CreateScheduleRequest request) {
        ScheduleDTO created = service.creat@@eSchedule(request);
