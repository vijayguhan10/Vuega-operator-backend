error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/scheduler/ScheduleController.java:_empty_/ScheduleService#getSchedulesByBus#
...
empty definition using pc, found symbol in pc: _empty_/ScheduleService#getSchedulesByBus#
...
public class ScheduleController {
    ...
    public ResponseEntity<ResponseDto<List<ScheduleDTO>>> getByBus(@PathVariable Long busId) {
        return ResponseEntity.ok(ResponseDto.success(service.getSch@@edulesByBus(busId)));
    }
