error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/scheduler/ScheduleController.java:_empty_/ResponseDto#
...
public class ScheduleController {
     ...
     */
    @PostMapping
    public ResponseEntity<Re@@sponseDto<ScheduleDTO>> create(@RequestBody CreateScheduleRequest request) {
