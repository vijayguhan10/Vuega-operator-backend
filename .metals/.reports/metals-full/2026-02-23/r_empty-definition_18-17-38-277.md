error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java:_empty_/SeatLockConflictException#
...
public class SeatController {
    ...
    public ResponseEntity<ResponseDto<SeatDTO>> unlock(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                    .body(ResponseDto.error(422, e.getMessage()));
        } catch (SeatLockCon@@flictException e) {
