error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/SeatSocketService.java:_empty_/SeatUpdateMessage#getStatus#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/SeatSocketService.java
empty definition using pc, found symbol in pc: _empty_/SeatUpdateMessage#getStatus#
...
public class SeatSocketService {
    ...
    public void broadcast(SeatUpdateMessage message) {
        ...
        log.debug("[SeatSocket] {} → seatId={} status={} count={}",
                ...
                message.getStatu@@s(), message.getCount());
    }
}
