error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java:_empty_/SeatDTO#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java
empty definition using pc, found symbol in pc: _empty_/SeatDTO#
...
public class SeatController {
    ...
    @PostMapping("/{id}/lock")
    public ResponseEntity<ResponseDto<Sea@@tDTO>> lock(
            @PathVariable Long id,
