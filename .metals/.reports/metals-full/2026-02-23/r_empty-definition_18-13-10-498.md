error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java:_empty_/SeatService#lockSeat#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java
empty definition using pc, found symbol in pc: _empty_/SeatService#lockSeat#
...
public class SeatController {
    ...
    public ResponseEntity<ResponseDto<SeatDTO>> lock(
        ...
        try {
            return ResponseEntity.ok(ResponseDto.success(service.lockS@@eat(id, request)));
        } catch (SeatNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ResponseDto.notFound(e.getMessage()));
