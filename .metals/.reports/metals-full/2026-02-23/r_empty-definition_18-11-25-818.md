error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java:_empty_/LockSeatRequest#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java
empty definition using pc, found symbol in pc: _empty_/LockSeatRequest#
...
public class SeatController {
    ...
    public ResponseEntity<ResponseDto<SeatDTO>> lock(
            @PathVariable Long id,
            @Valid @RequestBody L@@ockSeatRequest request) {
        try {
