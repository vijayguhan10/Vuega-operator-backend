error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/operator_config/OperatorConfigService.java:_empty_/OperatorConfigDTO#builder#licenseKey#
...
empty definition using pc, found symbol in pc: _empty_/OperatorConfigDTO#builder#licenseKey#
...
public class OperatorConfigService {
    ...
    private OperatorConfigDTO toDTO(OperatorConfig entity) {
        return OperatorConfigDTO.builder()
                ...
                .licenseK@@ey(entity.getLicenseKey())
