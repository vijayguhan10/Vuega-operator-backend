error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Model/operator_config/OperatorConfig.java:java/lang/System#
...
public class OperatorConfig {
    ...
    private String 
    licenseKey;
    Syste@@m.out.println("License Key: " + licenseKey);
