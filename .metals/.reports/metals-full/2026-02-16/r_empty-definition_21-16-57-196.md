error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/operatorConfig/OperatorConfigController.java:_empty_/OperatorConfigDTO#
...
empty definition using pc, found symbol in pc: _empty_/OperatorConfigDTO#
...
public class OperatorConfigController {
    ...
    // READ ALL
    @GetMapping
    public ResponseEntity<List<OperatorConfigDT@@O>> findAll() {
