error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/operatorConfig/OperatorConfigController.java:_empty_/HttpStatus#CREATED#
...
public class OperatorConfigController {
    ...
    public ResponseEntity<OperatorConfigDTO> create(@RequestBody OperatorConfigDTO dto) {
        ...
        return ResponseEntity.status(HttpStatus.CRE@@ATED).body(created);
    }
