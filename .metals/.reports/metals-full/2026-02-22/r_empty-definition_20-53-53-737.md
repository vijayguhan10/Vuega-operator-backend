error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/SeatSocketService.java:_empty_/SimpMessagingTemplate#convertAndSend#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/SeatSocketService.java
empty definition using pc, found symbol in pc: _empty_/SimpMessagingTemplate#convertAndSend#
...
public class SeatSocketService {
    ...
    public void broadcast(SeatUpdateMessage message) {
        messagingTemplate.convertAndSe@@nd(SEAT_TOPIC, message);
