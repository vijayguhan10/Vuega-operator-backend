error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java:_empty_/CreateSeatsInBatchRequest#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/SeatController.java
empty definition using pc, found symbol in pc: _empty_/CreateSeatsInBatchRequest#
...
public class SeatController {
    ...
    public ResponseEntity<ResponseDto<List<SeatDTO>>> createBatch(
            @Valid @RequestBody CreateSeats@@InBatchRequest request) {
        try {
