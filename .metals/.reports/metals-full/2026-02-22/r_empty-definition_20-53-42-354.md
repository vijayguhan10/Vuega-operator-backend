error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/SeatSocketService.java:_empty_/SeatUpdateMessage#getEvent#
...
public class SeatSocketService {
    ...
    public void broadcast(SeatUpdateMessage message) {
        ...
        log.debug("[SeatSocket] {} → seatId={} status={} count={}",
                message.get@@Event(), message.getSeatId(),
