error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/booking/SeatBookingController.java:_empty_/MultiSeatBookingService#createBooking#
file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/booking/SeatBookingController.java
empty definition using pc, found symbol in pc: _empty_/MultiSeatBookingService#createBooking#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2377
uri: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Controller/seats/booking/SeatBookingController.java
text:
```scala
...
public class SeatBookingController {
    ...
    public ResponseEntity<ResponseDto<MultiSeatBookingResponse>> createBooking(
        ...
        try {
            MultiSeatBookingResponse response = multiSeatBookingService.cre@@ateBooking(request);
