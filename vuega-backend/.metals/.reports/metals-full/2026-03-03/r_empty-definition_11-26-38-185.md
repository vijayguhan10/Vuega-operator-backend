error id: file:///C:/Projects/Vuega-backend/vuega-backend/src/main/java/net/vuega/vuega_backend/Service/seats/lock/SeatLockService.java:net/vuega/vuega_backend/Exception/SessionExpiredException#
...
empty definition using pc, found symbol in pc: net/vuega/vuega_backend/Exception/SessionExpiredException#
...
import net.vuega.vuega_backend.Exception.SeatAlreadyBookedException;
import net.vuega.vuega_backend.Exception.SeatAlreadyLockedException;
        ...
        public SeatLockDTO acquireLock(Long seatId, AcquireLockRequest request) {
                ...
                if (request.getSessionId() != null) {
                        ...
                        if (session.getExpiresAt().isBefore(LocalDateTime.now())) {
                                throw new SessionExpiredException(request.getSessionId());
                        }
                } else {
