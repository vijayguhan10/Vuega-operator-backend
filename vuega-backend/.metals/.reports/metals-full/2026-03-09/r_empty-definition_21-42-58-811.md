error id: file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Control_pannel/controller/buses/BusController.java:net/vuega/vuega_backend/Control_pannel/dto/common/ApiResponse#
file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Control_pannel/controller/buses/BusController.java
empty definition using pc, found symbol in pc: net/vuega/vuega_backend/Control_pannel/dto/common/ApiResponse#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 793
uri: file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Control_pannel/controller/buses/BusController.java
text:
```scala
package net.vuega.vuega_backend.Control_pannel.controller.buses;
