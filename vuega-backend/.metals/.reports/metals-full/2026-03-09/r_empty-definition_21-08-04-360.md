error id: file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Operator_pannel/Service/cache/ControlPanelCacheService.java:_empty_/`<any>`#opsForHash#putAll#
file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Operator_pannel/Service/cache/ControlPanelCacheService.java
empty definition using pc, found symbol in pc: _empty_/`<any>`#opsForHash#putAll#
