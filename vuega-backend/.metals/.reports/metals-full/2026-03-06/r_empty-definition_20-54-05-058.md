error id: file://<WORKSPACE>/src/main/java/net/vuega/vuega_backend/Controller/seats/booking/SeatBookingController.java:_empty_/MultiSeatBookingRequest#
...
public class SeatBookingController {
    ...
    public ResponseEntity<ResponseDto<MultiSeatBookingResponse>> createBooking(
            @Valid @RequestBody MultiSeatBookin@@gRequest request) {
        try {
