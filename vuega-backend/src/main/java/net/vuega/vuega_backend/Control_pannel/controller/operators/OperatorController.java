package net.vuega.vuega_backend.Control_pannel.controller.operators;
...
@RestController("controlPanelOperatorController")
@RequestMapping("/api/control-panel/operators")
