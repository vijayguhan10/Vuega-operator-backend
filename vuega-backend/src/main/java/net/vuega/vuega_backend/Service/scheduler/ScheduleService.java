...
public class ScheduleService {
    ...
    public ScheduleDTO updateSchedule(Long id, UpdateScheduleRequest request) {
        ...
        if (request.getBusId() != null) schedule.setBusId(request.getBusId());
        if (request.getRouteId() != null) schedule.setRouteId(request.getRouteId());
        if (request.getDepartTime() != null) schedule.setDepartTime(request.getDepartTime());
        if (request.getArriveTime() != null) schedule.setArriveTime(request.getArriveTime());
    ...
    /**
     * Converts entity to DTO and enriches with bus & route details from Control Plane.
     */
    ...
    /**
     * Fetch bus info from Control Plane: GET http://localhost:3000/api/controlplane/buses/{busId}
     */
    ...
    /**
     * Fetch route info from Control Plane: GET http://localhost:3000/api/controlplane/routes/{routeId}
     */
    @SuppressWarnings("unchecked")
